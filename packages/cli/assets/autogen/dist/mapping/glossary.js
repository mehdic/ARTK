 ...
 */
export function mergeGlossaries(base, extension) {
    const merged = {
 ...
 */
export function initGlossary(glossaryPath) {
    if (glossaryPath) {
 ...
 */
export function resolveCanonical(term) {
    if (!synonymMap) {
        initGlossary();
    }
 ...
 */
export function getSynonyms(canonical) {
    if (!glossaryCache) {
        initGlossary();
    }
 ...
 */
export function isSynonymOf(term, canonical) {
 ...
 */
export function findLabelAlias(label) {
    if (!glossaryCache) {
        initGlossary();
    }
 ...
 */
export function getLocatorFromLabel(label) {
 ...
 */
export function findModuleMethod(text) {
    if (!glossaryCache) {
        initGlossary();
    }
 ...
 */
export function resolveModuleMethod(text) {
