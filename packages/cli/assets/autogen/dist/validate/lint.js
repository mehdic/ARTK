 ...
 */
export const PLAYWRIGHT_LINT_RULES = {
 ...
 */
export function generateESLintConfig(rules = PLAYWRIGHT_LINT_RULES) {
 ...
 */
export function isESLintAvailable(cwd) {
    try {
 ...
 */
export function isPlaywrightPluginAvailable(cwd) {
    try {
 ...
 */
export async function lintCode(code, filename = 'test.spec.ts', options = {}) {
 ...
 */
export function hasLintErrors(code) {
