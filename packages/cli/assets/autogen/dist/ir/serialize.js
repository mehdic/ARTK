 ...
 */
export function serializeJourney(journey, options = {}) {
 ...
 */
export function serializeStep(step, options = {}) {
    const { pretty = true, indent = 2 } = options;
 ...
 */
export function serializePrimitive(primitive, options = {}) {
    const { pretty = true, indent = 2 } = options;
 ...
 */
export function describePrimitive(primitive) {
