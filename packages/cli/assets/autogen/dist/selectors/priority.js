 ...
 */
export const DEFAULT_SELECTOR_PRIORITY = [
    'role',
    'label',
    'placeholder',
    'text',
 ...
 */
export const ELEMENT_TYPE_STRATEGIES = {
 ...
 */
export function getSelectorPriority(config) {
 ...
 */
export function isForbiddenSelector(locator, config) {
 ...
 */
export function scoreLocator(locator, priority = DEFAULT_SELECTOR_PRIORITY) {
 ...
 */
export function compareLocators(a, b, priority = DEFAULT_SELECTOR_PRIORITY) {
 ...
 */
export function selectBestLocator(alternatives, config) {
 ...
 */
export function toPlaywrightLocator(locator) {
