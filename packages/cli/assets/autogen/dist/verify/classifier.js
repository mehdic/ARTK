 ...
 */
export function classifyTestResults(results) {
 ...
 */
export function getFailureStats(classifications) {
    const stats = {
        selector: 0,
        timing: 0,
        navigation: 0,
 ...
 */
export function isHealable(classification) {
 ...
 */
export function getHealableFailures(classifications) {
 ...
 */
export function generateClassificationReport(classifications) {
    const lines = [];
