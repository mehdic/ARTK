 ...
 */
type ValidationStatus = 'passed' | 'failed' | 'warnings';
/**
 * Strictness level for validation rules
 */
type StrictnessLevel = 'error' | 'warning' | 'ignore';
/**
 * Known validation rule IDs
 */
type ValidationRuleId = 'import-meta-usage' | 'dirname-usage' | 'import-paths' | 'dependency-compat' | 'typescript-compat';
/**
...
export type { GenerationTransaction as G, RollbackResult as R, StrictnessLevel as S, ValidationSeverity as V, ValidationStatus as a, ValidationRuleId as b, ValidationIssue as c, ValidationRuleResult as d, ValidationResult as e, ValidationOptions as f, ValidationRuleConfig as g, ValidationRule as h };
