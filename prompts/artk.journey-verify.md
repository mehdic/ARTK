...
agent: agent
handoffs:
  - label: "1. IF TESTS PASSED - /artk.journey-implement: journey complete! implement another"
    agent: artk.journey-implement
    prompt: "id=JRN-####"
  - label: "2. IF TESTS FAILED - /artk.journey-verify: fix issues and re-run verification"
    agent: artk.journey-verify
    prompt: "id=<JRN-ID>"
  - label: "3. IF FLAKY - /artk.journey-verify: stabilize tests and re-verify"
    agent: artk.journey-verify
    prompt: "id=<JRN-ID> heal=auto"
---
