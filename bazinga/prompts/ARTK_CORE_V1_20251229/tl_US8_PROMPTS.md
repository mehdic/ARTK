...
**T111-T112: Updated /init prompt**
- Added instructions to copy ARTK Core v1 framework to `.core/` directory
- Updated config requirements to use ARTK Core v1 schema
- Added documentation about core framework integration
- Included examples of env var refer

**[developer] approach:** ## Approach

### Analysis of Existing Prompts
All 5 prompts exist and follow a consistent structure:
- YAML frontmatter (name, description, argument-hint, agent)
- Detailed instructions for AI assistants
- No current references to core framework modules
- Each prompt guides AI to create code from sc

**[developer] understanding:** ## Understanding

### Task Interpretation
Phase 11: Integration Testing - Write integration tests to verify that ARTK Core modules work together correctly. This involves three specific test files:
- T108: Config-to-harness integration test
- T109: Auth flow integration test (with mock IdP)
- T110: F
...
**Consider if relevant:** `codebase-analysis`, `pattern-miner`, `test-pattern-analysis`
...
**TASK:** Review Phase 12: US8 Prompt Integration with Core (T111-T121)

**REQUIREMENTS:**
Review the updated ARTK prompts.

**Files to Review in prompts/:**
- init.prompt.md - Updated to copy core and generate artk.config.yml
- foundation-build.prompt.md - Updated to import createPlaywrightConfig from core
- journey-implement.prompt.md - Updated to import fixtures, locators, assertions from core
- journey-validate.prompt.md - Updated to check for correct core API usage
- journey-verify.prompt.md - Updated to use core fixtures and harness

**Also review:**
- docs/PROMPT_TESTING.md - Testing guide for prompt validation

**Validation:**
- Prompts reference @artk/core/* modules
- AI assistants will generate code using core framework
