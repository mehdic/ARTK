...
import { getArtkVersion, getVariantDistPath, validateVariantBuildFiles, generateVariantFeatures, generateReadonlyMarker, generateAiIgnore, generateCopilotInstructions, checkVariantNodeCompatibility, } from '../variant-files.js';
...
describe('variant-files', () => {
    ...
    describe('generateVariantFeatures', () => {
        it('should generate features for modern-esm', () => {
            ...
            expect(features.features.esm_imports).toEqual({ available: true });
            expect(features.features.top_level_await).toEqual({ available: true });
        });
        it('should generate features for modern-cjs', () => {
            ...
            const esmImports = features.features.esm_imports;
        ...
        it('should generate features for legacy-14 with limitations', () => {
            ...
            const ariaSnapshots = features.features.aria_snapshots;
        ...
        it('should include common features for all variants', () => {
            const variants = ['modern-esm', 'modern-cjs', 'legacy-16', 'legacy-14'];
            for (const variant of variants) {
                const features = generateVariantFeatures(variant);
                const featuresObj = features.features;
...
//# sourceMappingURL=variant-files.test.js.map