...
import { getRecommendedVariant, isVariantCompatible, MIN_NODE_VERSION, VARIANT_DEFINITIONS, } from './variant-definitions.js';
/**
 ...
 */
export function getNodeVersionFull() {
 ...
 */
export function detectModuleSystem(targetPath) {
 ...
 */
export function detectEnvironment(targetPath) {
    try {
 ...
 */
export function selectVariant(options) {
    ...
    if (options.overrideVariant) {
        const isCompatible = isVariantCompatible(options.overrideVariant, detection.nodeVersion);
        if (!isCompatible) {
 ...
 */
export function validateVariantCompatibility(variantId, nodeVersion) {
 ...
 */
export function hasExistingInstallation(targetPath) {
 ...
 */
export function readExistingContext(targetPath) {
    const contextPath = path.join(targetPath, '.artk', 'context.json');
 ...
 */
export function detectEnvironmentChange(targetPath) {
...
//# sourceMappingURL=variant-detector.js.map