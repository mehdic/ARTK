...
import { detectEnvironment, hasExistingInstallation, getNodeMajorVersion, } from '../utils/variant-detector.js';
import { getVariantDefinition, MIN_NODE_VERSION, } from '../utils/variant-definitions.js';
 ...
 */
export function printUpgradeResults(result) {
    if (!result.success) {
