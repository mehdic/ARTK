 ...
 */
declare function getLoggerConfig(): Readonly<LoggerConfig>;
/**
 * Logger interface
 */
interface Logger {
 ...
 * ```
 */
declare function createLogger(module: string, operation: string): Logger;
/**
 ...
 * ```
 */
declare function parseLogLevel(level: string | undefined): LogLevel | undefined;

export { type Logger as L, configureLogger as a, type LogEntry as b, createLogger as c, type LogLevel as d, type LoggerConfig as e, getLoggerConfig as g, parseLogLevel as p };
