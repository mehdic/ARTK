 ...
 */
interface RowCountOptions extends AssertionOptions {
 ...
 * ```
 */
type AgGridFactory = (page: Page, config: string | AgGridConfig) => AgGridHelper;
 ...
 * ```
 */
declare const agGrid: AgGridFactory;

export { type AgGridColumnDef, type AgGridConfig, type AgGridFactory, type AgGridHelper, type AgGridRowData, type AgGridState, type AssertionOptions, type CellRendererConfig, type ColumnType, DEFAULT_TIMEOUTS, type EnterpriseConfig, type RowCountOptions, type RowMatcher, type SortModel, type TimeoutConfig, agGrid };
