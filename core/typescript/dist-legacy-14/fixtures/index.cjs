...
__export(base_exports, {
  ...
  testWithConfig: () => exports.testWithConfig
});
...
var logger5; exports.testWithConfig = void 0;
var init_base = __esm({
  "fixtures/base.ts"() {
    init_loader();
    init_logger();
    logger5 = createLogger("fixtures", "base");
    exports.testWithConfig = test$1.test.extend({
      config: async ({}, use) => {
...
var testWithAuthPages = exports.testWithConfig.extend({
...
async function createAPIContext(config, storageStatePath) {
  ...
  return test$1.request.newContext({
    baseURL: options.baseURL,
...
var CleanupManager = class {
  constructor() {
    ...
    __publicField(this, "cleanupRun", false);
  }
  /**
...
exports.generateRunId = generateRunId2;
...
exports.test = test;
exports.testWithAPIContext = testWithAPIContext;
exports.testWithAuthPages = testWithAuthPages;
exports.testWithData = testWithData;
