import { A as AriaRole } from '../factory-BCufm4t2.js';
export { B as ByRoleOptions, F as FormLocators, e as LocatorFactoryConfig, L as LocatorStrategy, f as LocatorStrategyFn, S as SectionLocators, T as TableLocators, i as byCss, a as byLabel, g as byPlaceholder, b as byRole, c as byTestId, h as byText, n as createCombinedTestIdSelector, q as createConfigFromSelectors, p as createDefaultConfig, m as createTestIdSelector, k as getTestIdValue, j as hasTestIdAttribute, l as locate, t as tryStrategy, w as withinForm, o as withinSection, d as withinTable } from '../factory-BCufm4t2.js';
 ...
 * ```
 */
declare function getAriaRole(locator: Locator): Promise<string | null>;
/**
 ...
 * ```
 */
declare function getAriaLabel(locator: Locator): Promise<string | null>;
/**
 ...
 * ```
 */
declare function getAriaDescription(locator: Locator): Promise<string | null>;
/**
 ...
 * ```
 */
declare function isAriaDisabled(locator: Locator): Promise<boolean>;
/**
 ...
 * ```
 */
declare function isAriaExpanded(locator: Locator): Promise<boolean | null>;
/**
 ...
 * ```
 */
declare function isAriaChecked(locator: Locator): Promise<boolean | null>;
/**
 ...
 * ```
 */
declare function isAriaHidden(locator: Locator): Promise<boolean>;
/**
 ...
 * ```
 */
declare function getAriaLive(locator: Locator): Promise<'polite' | 'assertive' | 'off' | null>;
/**
 ...
 * ```
 */
declare function isAriaRequired(locator: Locator): Promise<boolean>;
/**
 ...
 * ```
 */
declare function isAriaInvalid(locator: Locator): Promise<boolean>;
/**
 ...
 * ```
 */
declare function getAccessibleName(locator: Locator): Promise<string | null>;
/**
 ...
 * ```
 */
declare function isValidAriaRole(role: string): role is AriaRole;

export { AriaRole, getAccessibleName, getAriaDescription, getAriaLabel, getAriaLive, getAriaRole, isAriaChecked, isAriaDisabled, isAriaExpanded, isAriaHidden, isAriaInvalid, isAriaRequired, isValidAriaRole };
