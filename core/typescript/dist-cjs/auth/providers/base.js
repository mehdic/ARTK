...
exports.BaseAuthProvider = exports.DEFAULT_AUTH_RETRY_OPTIONS = void 0;
...
class BaseAuthProvider {
    ...
    constructor(providerName, retryOptions = {}) {
        ...
        this.logger = (0, logger_js_1.createLogger)('auth', providerName);
        this.retryOptions = {
            ...exports.DEFAULT_AUTH_RETRY_OPTIONS,
            ...retryOptions,
        };
     ...
     */
    async isElementVisible(page, selector, timeout = 1000) {
        try {
