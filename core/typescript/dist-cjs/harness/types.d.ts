 ...
 */
export type CreateAuthSetupProjectFn = (role: string, storageStatePath: string, testMatch?: string) => PlaywrightProject;
/**
 * Factory function signature for creating browser projects
 */
export type CreateBrowserProjectsFn = (browsers: readonly BrowserType[], roles: readonly string[], storageStateDir: string, filePattern: string, dependencies?: readonly string[]) => readonly PlaywrightProject[];
/**
 ...
 */
export type GetUseOptionsFn = (config: ARTKConfig, activeEnvironment?: string) => UseOptions;
