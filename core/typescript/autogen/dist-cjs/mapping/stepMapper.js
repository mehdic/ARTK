...
const parseHints_js_1 = require("../journey/parseHints.js");
/**
...
function mapStepText(text, options = {}) {
    ...
    const hints = (0, parseHints_js_1.extractHints)(text);
    const cleanText = hints.hasHints ? hints.cleanText : text;
    // Normalize text if enabled
    const processedText = normalizeText ? (0, glossary_js_1.normalizeStepText)(cleanText) : cleanText;
    // Try to match against patterns
    let primitive = (0, patterns_js_1.matchPattern)(processedText);
    ...
    else if (!primitive && (0, parseHints_js_1.hasLocatorHints)(hints)) {
...
function applyHintsToPrimitive(primitive, hints) {
    ...
    if ((0, parseHints_js_1.hasLocatorHints)(hints)) {
    ...
    if ((0, parseHints_js_1.hasBehaviorHints)(hints)) {
        ...
        if (hints.behavior.module) {
            const parsed = (0, parseHints_js_1.parseModuleHint)(hints.behavior.module);
            if (parsed) {
