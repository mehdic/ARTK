...
const parsing_js_1 = require("../utils/parsing.js");
const USAGE = `
...
async function runVerify(args) {
    ...
    // Verify each journey
    const results = await (0, index_js_1.verifyJourneys)(journeyFiles, {
        outputDir: values.output,
        heal: values.heal,
        maxHealAttempts: (0, parsing_js_1.parseIntSafe)(values['max-heal'], 'max-heal', 3),
        checkStability: values.stability,
        stabilityRuns: (0, parsing_js_1.parseIntSafe)(values['stability-runs'], 'stability-runs', 3),
        reporter: values.reporter,
        timeout: values.timeout ? (0, parsing_js_1.parseIntSafe)(values.timeout, 'timeout', 30000) : undefined,
    });
    // Format output
