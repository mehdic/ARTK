...
type PipelineState = 'IDLE' | 'PARSING' | 'PLANNING' | 'GENERATING' | 'SCORING' | 'EXECUTING' | 'REFINING' | 'LEARNING' | 'DONE' | 'BLOCKED' | 'DEAD_END' | 'FAILED';
...
type index$3_PipelineState = PipelineState;
