 ...
 * ```
 */
export declare function regenerateTestWithBlocks(journey: IRJourney, existingCode: string, options?: Omit<GenerateTestOptions, 'strategy' | 'existingCode'>): GenerateTestResult;
/**
