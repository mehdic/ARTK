 ...
 */
export function hasDataIsolation(code) {
 ...
 */
export function addRunIdVariable(code) {
 ...
 */
export function namespaceEmail(email, runId) {
 ...
 */
export function namespaceName(name, runId) {
    return `${name} ${runId}`;
}
/**
 * Replace hardcoded email with namespaced version
 */
export function replaceHardcodedEmail(code) {
 ...
 */
export function replaceHardcodedTestData(code) {
 ...
 */
export function applyDataFix(context) {
    const { code } = context;
 ...
 */
export function addCleanupHook(code, cleanupCode) {
 ...
 */
export function extractTestDataPatterns(code) {
    const patterns = [];
