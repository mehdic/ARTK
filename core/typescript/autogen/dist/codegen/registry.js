 ...
 */
export function loadRegistry(indexPath) {
 ...
 */
export function parseIndexFile(content, _indexPath) {
    const entries = [];
 ...
 */
export function generateIndexContent(entries, options = {}) {
    const lines = [
        '/**',
 ...
 */
export function addToRegistry(registry, module, filePath) {
    const entry = {
 ...
 */
export function removeFromRegistry(registry, moduleNameOrPath) {
 ...
 */
export function updateIndexFile(indexPath, newModules, options = {}) {
 ...
 */
export function scanModulesDirectory(_dirPath, _pattern = '*.page.ts') {
 ...
 */
export function createRegistry(indexPath) {
    return {
        registryPath: indexPath,
        entries: [],
        lastUpdated: new Date(),
 ...
 */
export function findEntry(registry, moduleName) {
    return registry.entries.find(e => e.moduleName === moduleName);
}
/**
 * Find entry by scope
 */
export function findEntriesByScope(registry, scope) {
    return registry.entries.filter(e => e.scope === scope);
}
/**
 * Check if module exists in registry
 */
export function hasModule(registry, moduleName) {
    return registry.entries.some(e => e.moduleName === moduleName);
}
/**
 * Get all module names
 */
export function getModuleNames(registry) {
