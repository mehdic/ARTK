 ...
 */
export function scanForbiddenPatterns(code, patterns = FORBIDDEN_PATTERNS) {
    const results = [];
 ...
 */
export function scanResultsToIssues(results) {
 ...
 */
export function getPatternStats(results) {
    const stats = {};
 ...
 */
export function hasErrorViolations(results) {
