#!/usr/bin/env node
import { z } from 'zod';
import { existsSync, readFileSync, mkdirSync, writeFileSync, realpathSync, unlinkSync, rmSync, appendFileSync, statSync, readdirSync, renameSync, mkdtempSync } from 'fs';
