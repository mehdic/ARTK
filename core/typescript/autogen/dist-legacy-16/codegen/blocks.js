...
exports.BLOCK_ID_PATTERN = exports.BLOCK_END = exports.BLOCK_START = void 0;
 ...
 */
exports.BLOCK_START = '// ARTK:BEGIN GENERATED';
exports.BLOCK_END = '// ARTK:END GENERATED';
exports.BLOCK_ID_PATTERN = /ARTK:BEGIN GENERATED(?:\s+id=([a-zA-Z0-9_-]+))?/;
/**
...
function extractManagedBlocks(code) {
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        if (line.includes(exports.BLOCK_START)) {
            if (inBlock) {
            ...
            inBlock = true;
            const match = line.match(exports.BLOCK_ID_PATTERN);
            currentBlock = {
                id: match?.[1],
                startLine: i,
            };
        ...
        // Check for block end
        if (line.includes(exports.BLOCK_END) && inBlock) {
            inBlock = false;
            if (currentBlock) {
                blocks.push({
                    ...currentBlock,
