...
const logger = (0, logger_js_1.createLogger)('auth', 'generic-idp');
// =============================================================================
// Default Selectors
// =============================================================================
/**
 ...
 */
const DEFAULT_GENERIC_SELECTORS = {
...
function createGenericHandler(customSelectors) {
    ...
    return {
        ...
        async fillCredentials(page, credentials, selectors) {
            ...
            return exports.genericHandler.fillCredentials(page, credentials, finalSelectors);
        },
        async submitForm(page, selectors) {
            const finalSelectors = { ...mergedSelectors, ...selectors };
            return exports.genericHandler.submitForm(page, finalSelectors);
        },
        async handleMFA(page, mfaConfig) {
            return exports.genericHandler.handleMFA(page, mfaConfig);
        },
        async handlePostLoginPrompts(page, selectors) {
            const finalSelectors = { ...mergedSelectors, ...selectors };
            return exports.genericHandler.handlePostLoginPrompts(page, finalSelectors);
        },
        getDefaultSelectors() {
