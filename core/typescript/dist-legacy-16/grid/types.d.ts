 ...
 */
export type KeyboardAction = 'enter' | 'escape' | 'tab' | 'shiftTab' | 'space' | 'delete' | 'copy' | 'paste' | 'selectAll' | 'home' | 'end' | 'ctrlHome' | 'ctrlEnd' | 'pageUp' | 'pageDown';
/**
...
export interface AgGridHelperExtended extends AgGridHelper {
    ...
    findDetailGridWithData(cellValues: Record<string, unknown>, options?: NestedDetailOptions): Promise<AgGridHelperExtended | null>;
