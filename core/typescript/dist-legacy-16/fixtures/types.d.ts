 ...
 */
import type { APIRequestContext, Page, PlaywrightTestArgs, PlaywrightTestOptions, PlaywrightWorkerArgs, PlaywrightWorkerOptions, TestType } from '@playwright/test';
 ...
 */
export type FixtureDefinition<T, Args extends Record<string, unknown>> = (args: Args, use: (fixture: T) => Promise<void>) => Promise<void>;
/**
